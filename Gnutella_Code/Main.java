...
public class Main {
	...
	public static void main(String[] args)  {
		...
		try {
			...
			System.out.println("enter fileName,peer_id,sharedDir");
			String[] input=bufferedReader.readLine().split(" ");
			
			int peer_id=Integer.parseInt(input[1]);
			sharedDir=input[2];
			System.out.println("Peer "+peer_id+" stated with shared directory "+ sharedDir);
			Properties prop = new Properties();						//Properties class to read the configuration file					//Properties class to read the configuration file
		    fileName =input[0];
